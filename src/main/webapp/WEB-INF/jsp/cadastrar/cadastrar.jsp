				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form method="post" class="user"
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input name="usuario.nome" value="${usuario.nome}" minlength="3" maxlength="20" type="text"
											class="form-control form-control-user" id="exampleFirstName"
											placeholder="Nome">
									</div>
									<div class="col-sm-6">
										<input name="usuario.sobrenome" value="${usuario.sobrenome}" minlength="3" maxlength="20" type="text"
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input name="usuario.senha" value="${usuario.senha}" type="password" minlength="6" maxlength="20" class="form-control form-control-user"
							...
							<hr>
							<div class="text-center">
								<a class="small" href="<c:url value="login"/>">Já tem uma
									conta? Login!</a>
							</div>
						</div>
					</div>
