	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link"
				href="<c:url value="novaAposta"/>"> <i
					class="fas fa-fw fa-cube"></i> <span>Nova Aposta</span></a></li>
			<li class="nav-item"><a class="nav-link"
				href="<c:url value="apostar"/>"> <i class="fas fa-fw fa-cubes"></i>
					<span>Apostas</span></a></li>
						...
						<div class="col-12">
							...
							<div class="card shadow mb-4 card-novaaposta mx-auto">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary text-center">Confira
										quais números foram sorteados</h6>
								</div>
								<div class="card-body">
									...
									<div class="row mt-3">
										<div
											...
											<div>
												<h4>
													Codigo Aposta: <strong>5241</strong>
												</h4>
												<h4>
													Erros: <strong>6</strong>
												</h4>
												<h4>
													Acertos: <strong>9</strong>
												</h4>
												<h4>
													Ganhos: <strong>Nenhum</strong>
												</h4>
											</div>
										</div>
										<div class="col-md-6">
											<img class="imagem-novaaposta img-fluid" alt="dinheiro"
												src="img/register-fundo.png">
										</div>
									</div>

								</div>
								<div class="card-footer text-center">
									<a href="<c:url value="novaAposta"/>"
										class="btn btn-primary btn-icon-split btn-lg mt-3 mb-3 mr-4">
										<span class="icon text-white-50"> <i
											class="fas fa-plus"></i>
									</span> <span class="text">Nova Aposta</span>
									</a> <a href="<c:url value="apostar"/>"
										class="btn btn-info btn-icon-split btn-lg mt-3 mb-3"> <span
										class="icon text-white-50"> <i class="fas fa-cubes"></i>
									</span> <span class="text">Ver Apostas</span>
									</a>
								</div>
							</div>
							<!-- Fim card-->
